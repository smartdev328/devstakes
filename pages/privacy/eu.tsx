      ...
      <AppLayout token={token} subscriptions={subscriptions} bgColor={'#ffffff'}>
        <div className={styles.container}>
          <div className={`${styles.content} ${styles.privacy}`}>
            ...
            <p>We enable certain third party advertising exchanges to place advertisements on our sites. With your consent, those advertising exchanges collect your IP address and/or a unique advertising ID that is used by the advertising exchange to identify you across the internet.</p>
            <p>The European Digital Advertising Alliance “EDAA” has developed a guide to online behavioural advertising and has developed an opt out page to manage online behavioural advertising preferences with EDAA member companies available at <a href="www.YourOnlineChoices.com">www.YourOnlineChoices.com</a>.</p>

            <h5>Contact Us</h5>
            <p>For all EU Data Subject Rights requests, if you have any questions, or complaints, regarding the collection or use of your personal information or the content of this policy, or if you wish to withdraw your consent to us using your data, please contact us at <a href="mailto:info@thedailystakes.com">info@thedailystakes.com</a>. Back-up data of personal information will only be retained as long as it is necessary for data security purposes and will not be retained indefinitely.</p>
          </div>
        </div>
      </AppLayout>
    </>
