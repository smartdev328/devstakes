...
export const FANTASY_LINEUPS_INFO = [
  {
    sport: 'NBA',
    company: 'DraftKings',
    type: 'MAIN_SLATE',
...
export const FANTASY_LINEUPS_GAMES = [
  {
    id: 1,
    sport: 'NBA',
    company: 'DraftKings',
